# Adapted from https://github.com/meetps/pytorch-semseg/raw/master/ptsemseg/loader/pascal_voc_loader.py
import os
...
class pascalVOCLoader(data.Dataset):
	...
	def __getitem__(self, index):
		...
		classes_lbl = [self.classes[x] for x in torch.unique(lbl)[1:]-1]
		if len(classes_lbl) == 1:
			text = self.template + classes_lbl[0]
		else:
